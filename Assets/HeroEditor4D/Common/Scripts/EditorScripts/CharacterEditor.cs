        ...
        public void OnSelectTab(bool value)
        {
            ...
            switch (tab.name)
            {
                case "Armor":
                {
                    ...
                    equippedIndex = Character.Character.Armor == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Armor.SingleOrDefault(j => j.name == "CharacterBody")));
                    break;
                }
                case "Helmet":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Helmet));
                    break;
                }
                case "Vest":
                case "Bracers":
                case "Leggings":
                {
                    ...
                    switch (tab.name)
                    {
                        case "Vest": part = "CharacterBody"; break;
                        case "Bracers": part = "CharacterArmL"; break;
                        case "Leggings": part = "CharacterLegL"; break;
                    ...
                    equippedIndex = Character.Character.Armor == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Armor.SingleOrDefault(j => j.name == part)));
                    break;
                }
                case "Shield":
                {
                    ...
                    equippedIndex = Character.Character.Shield == null ? -1 : sprites.FindIndex(i => i.Sprites.SequenceEqual(Character.Character.Shield));
                    break;
                }
                case "Melee1H":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.PrimaryWeapon));
                    break;
                }
                case "Melee2H":
                {
                ...
                case "Bow":
                {
                    ...
                    equippedIndex = Character.Character.CompositeWeapon == null ? -1 : sprites.FindIndex(i => i.Sprites.SequenceEqual(Character.Character.CompositeWeapon));
                    break;
                }
                case "Crossbow":
                {
                ...
                case "Firearm1H":
                {
                    ...
                    equippedIndex = Character.Character.SecondaryWeapon == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.PrimaryWeapon));
                    break;
                }
                case "Firearm2H":
                {
                    ...
                    equippedIndex = Character.Character.PrimaryWeapon == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.PrimaryWeapon));
                    break;
                }
                case "SecondaryFirearm1H":
                {
                    ...
                    equippedIndex = Character.Character.SecondaryWeapon == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.SecondaryWeapon));
                    break;
                }
                case "Body":
                {
                    ...
                    equippedIndex = Character.Character.Body == null ? -1 : sprites.FindIndex(i => i.Sprites.SequenceEqual(Character.Character.Body));
                    break;
                }
                case "Head":
                {
                    ...
                    equippedIndex = Character.Character.Head == null ? -1 : sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Head));
                    break;
                }
                case "Ears":
                {
                    ...
                    equippedIndex = Character.Character.Ears == null ? -1 : sprites.FindIndex(i => i.Sprites.SequenceEqual(Character.Character.Ears));
                    break;
                }
                case "Eyebrows":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Expressions[0].Eyebrows));
                    break;
                }
                case "Eyes":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Expressions[0].Eyes));
                    break;
                }
                case "Hair":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Hair));
                    break;
                }
                case "Beard":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Beard));
                    break;
                }
                case "Mouth":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Expressions[0].Mouth));
                    break;
                }
                case "Makeup":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Makeup));
                    break;
                }
                case "Mask":
                {
                    ...
                    equippedIndex = sprites.FindIndex(i => i.Sprites.Contains(Character.Character.Mask));
                    break;
                }
                case "Earrings":
                {
                    ...
                    equippedIndex = Character.Character.Earrings == null ? -1 : sprites.FindIndex(i => i.Sprites.SequenceEqual(Character.Character.Earrings));
                    break;
                }
                case "Supplies":
                {
